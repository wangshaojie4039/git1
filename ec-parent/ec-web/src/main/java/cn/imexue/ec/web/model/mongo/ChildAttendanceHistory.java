...
public class ChildAttendanceHistory {
	...
	@ExcelExportProperties(columnName="校园人数",order=2)
	public int totalNum(){
	...
	public String attendVal(){
		...
		BigDecimal divide = new BigDecimal(attendNum()).divide(new BigDecimal(totalNum()),BigDecimal.ROUND_HALF_UP,4);
